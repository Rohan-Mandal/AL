codeunit 50103 "Game Engine"
{
    ...
    var
        Position: Integer;
    begin
        //Verify if there is any blank space left
        for Position := 1 to 9 do
